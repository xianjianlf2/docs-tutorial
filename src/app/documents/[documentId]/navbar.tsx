...
export default function Navbar({
    ...
    const handleExport = useCallback((format: 'json' | 'pdf' | 'text' | 'html') => {
        if (!editor) {
    ...
    return (
        <nav className="flex items-center justify-between" aria-label="Document navigation">
            <div className="flex gap-2 items-center">
                ...
                <div className="flex flex-col">
                    <DocumentInput />
                    <div className="flex">
                        <Menubar className="border-none bg-transparent shadow-none h-auto p-0" aria-label="Document menu">
                            <MenubarMenu>
                                <MenubarTrigger className="text-sm font-normal py-0.5 px-[7px] rounded-sm hover:bg-muted h-auto">
                                    File
                                </MenubarTrigger>
                                <MenubarContent className="print:hidden">
                                    <MenubarItem onClick={handleNew} className="gap-2">
                                        <FileIcon className="size-4" />
                                        <span>New Document</span>
                                        <MenubarShortcut>Ctrl+N</MenubarShortcut>
                                    </MenubarItem>
                                    <MenubarItem onClick={handleOpen} className="gap-2">
                                    ...
                                    <MenubarSub>
                                        ...
                                        <MenubarSubContent>
                                            <MenubarItem onClick={() => handleExport('json')} className="gap-2">
                                                <FileJson className="size-4" />
                                                <span>JSON</span>
                                            </MenubarItem>
                                            <MenubarItem onClick={() => handleExport('pdf')} className="gap-2">
                                                <FileType className="size-4" />
                                                <span>PDF</span>
                                            </MenubarItem>
                                            <MenubarItem onClick={() => handleExport('text')} className="gap-2">
                                                <FileText className="size-4" />
                                                <span>Text</span>
                                            </MenubarItem>
                                            <MenubarItem onClick={() => handleExport('html')} className="gap-2">
                                                <FileCode className="size-4" />
                                                <span>HTML</span>
                                            </MenubarItem>
                                        </MenubarSubContent>
                                    </MenubarSub>
                                    <MenubarItem onClick={handleRename} className="gap-2">
                                    ...
                                    <MenubarSeparator />
                                    <MenubarItem onClick={handleRemove} className="gap-2">
                            ...
                            <MenubarMenu>
                                ...
                                <MenubarContent className="print:hidden">
                                    <MenubarItem onClick={handleUndo} disabled={!canUndo} className="gap-2">
                                        <Undo className="size-4" />
                                        <span>Undo</span>
                                        <MenubarShortcut>Ctrl+Z</MenubarShortcut>
                                    </MenubarItem>
                                    <MenubarItem onClick={handleRedo} disabled={!canRedo} className="gap-2">
                            ...
                            <MenubarMenu>
                                ...
                                <MenubarContent className="print:hidden">
                                    ...
                                    <MenubarItem onClick={handleStrikethrough} className="gap-2">
                                        <Strikethrough className="size-4" />
                                        <span>Strikethrough</span>
                                        <MenubarShortcut>Ctrl+Shift+X</MenubarShortcut>
                                    </MenubarItem>
                                    <MenubarSeparator />
                                    <MenubarItem onClick={handleClearFormat} className="gap-2">
